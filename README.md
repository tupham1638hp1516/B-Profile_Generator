...
Những nguyên mẫu này sau đó được sử dụng làm khuôn mẫu để máy tự động sinh ra hàng triệu luồng traffic giả lập. Kết quả là ta có một nền tảng dữ liệu mạng sạch, giống người thật, nhưng an toàn về bảo mật thông tin.

## 📁 Cấu trúc Tài liệu

Dự án bao gồm 2 tài liệu chính để bạn có thể nắm bắt trọn vẹn từ lý thuyết đến thực hành:

1. **[`Towards a Reliable Intrusion DetectionBenchmark Dataset.md`](./Towards%20a%20Reliable%20Intrusion%20DetectionBenchmark%20Dataset.md)**
